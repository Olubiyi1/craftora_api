-- CreateEnum
CREATE TYPE "Role" AS ENUM ('STUDENT', 'INSTRUCTOR', 'MODERATOR', 'ADMIN');
...
-- AddForeignKey
ALTER TABLE "Course" ADD CONSTRAINT "Course_instructorProfileId_fkey" FOREIGN KEY ("instructorProfileId") REFERENCES "InstructorProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
